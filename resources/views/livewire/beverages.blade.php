<div class="w-full">
    ...
    <table class="table min-w-full mt-4">
        ...
        <tr>
            ...
            <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">Selling Price</th>
            <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">Purchase Price</th>
            ...
            <form wire:submit.prevent="save" class="w-full">
                <div class="flex flex-col items-start p-4">
                    ...
                    <div class="w-full">
                        ...
                        <input wire:model.defer="product.selling_price"
                               class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div class="py-4 border-b w-full mb-4">
                        ...
                        <input wire:model.defer="product.purchase_price"
                               class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div class="ml-auto">
