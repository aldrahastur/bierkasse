<div>
    ...
    <table class="table min-w-full mt-4">
        <thead>
        <tr>
            <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">Firstname</th>
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
                    <button
                        ...
                        wire:click.prevent="edit({{ $member->id }})">Edit
                    </button>
                    <button
            ...
            <form wire:submit.prevent="save" class="w-full">
                <div class="flex flex-col items-start p-4">
                    <div class="flex items-center w-full border-b pb-4">
                        <div class="text-gray-900 font-medium text-lg">{{ $memberId ? 'Edit Member' : 'Add New Member' }}</div>
                    ...
                    <div class="w-full">
                        ...
                        <input wire:model.defer="member.firstname"
                    ...
                    <div class="py-4 w-full">
                        ...
                        <input wire:model.defer="member.lastname"
                               class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div class="py-4 border-b w-full mb-4">
                        ...
                        <input wire:model.defer="member.email"
                               class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div class="ml-auto">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                type="submit">{{ $memberId ? 'Save Changes' : 'Save' }}
                        </button>
